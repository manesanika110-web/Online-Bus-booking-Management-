...
const DashboardIcon = ({ active }) => (
  ...
  >
    <rect
      ...
      strokeWidth="1.8"
      fill={active ? "rgba(255,255,255,0.15)" : "#f8fafc"}
    />
    <rect
      x="6"
      y="10"
...
const BusesIcon = ({ active }) => (
  ...
  >
    <rect
      ...
      strokeWidth="1.8"
      fill={active ? "rgba(255,255,255,0.15)" : "#ffffff"}
    />
    <rect
      x="5.5"
      y="6"
...
const BookingsIcon = ({ active }) => (
  ...
  >
    <rect
      ...
      strokeWidth="1.8"
      fill={active ? "rgba(255,255,255,0.15)" : "#e0f2fe"}
    />
    <line
      x1="8"
      y1="5"
...
function AdminSidebar({
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: "Payments",
      Icon: PaymentsIcon,
      badge: counts.payments || 0,
    },
    {
      id: "support",
      label: "Support Queries",
      Icon: SupportQueriesIcon,
      badge: counts.supportQueries || 0,
    },
    {
      id: "livetracking",
      label: "Live Location",
      Icon: LiveTrackingIcon,
      badge: counts.liveBuses || "LIVE",
      isLiveBadge: true,
    },
  ];
      ...
      <aside className={`admin-sidebar ${isMobileOpen ? "mobile-open" : ""}`}>
                ...
                <li key={item.id} className="sidebar-menu-item">
                  ...
                  >
                    ...
                    {item.badge !== null && item.badge !== undefined && (
                      <span
                        className={`sidebar-count-badge ${isActive ? "badge-active" : ""} ${item.isLiveBadge ? "badge-live-pulse" : ""}`}
                      >
                        {item.badge}
                      </span>
                    )}
        ...
        <div className="admin-sidebar-footer">
          <Link
            ...
            title="Open User Booking Website"
          >
